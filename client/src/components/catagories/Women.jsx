...
import { fetchWomenProducts } from "../../Slices/womenSlice";
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl pt-24 pb-16">
        <div className="text-center">
          ...
          <p className="mt-8 text-xl text-black max-w-2xl mx-auto leading-relaxed">
            Discover our premium selection of women's fashion. From casual to
          ...
          <div className="flex justify-center mt-12">
            <nav className="flex items-center gap-1">
              <button
                ...
                className="px-3 py-1 rounded border border-[#F0BB78]/20 text-[#F0BB78] hover:bg-[#F0BB78]/20 disabled:opacity-50"
              >
                Previous
              </button>
                ...
                <button
                  ...
                  className={`px-3 py-1 rounded border ${
                    currentPage === i + 1
                      ...
                      : "border-[#F0BB78]/20 text-[#F0BB78] hover:bg-[#F0BB78]/20"
                  }`}
                >
                  {i + 1}
                </button>
