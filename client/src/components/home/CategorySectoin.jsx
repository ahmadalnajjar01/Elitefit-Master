...
// You'll need a new image for New Arrivals - I'm assuming you have one named "new-arrivals.jpg"
// Replace this with your actual image path
import NewArrivals from "../../assets/Images/S5.png";
...
const CategoryCard = ({
  ...
  return (
    ...
    >
      ...
      {isNew && (
        <div className="absolute top-2 right-2 sm:top-4 sm:right-4 z-30 rotate-12 transform transition-all duration-500 group-hover:rotate-0 group-hover:scale-110">
          <div className="bg-[#F0BB78] text-white font-bold py-1 px-3 sm:py-1.5 sm:px-4 rounded-full shadow-[0_0_20px_rgba(99,102,241,0.4)] flex items-center text-xs sm:text-sm">
            <svg
              className="w-3 h-3 sm:w-4 sm:h-4 mr-1 animate-pulse"
              fill="currentColor"
              viewBox="0 0 20 20"
...
const CategorySection = () => {
  ...
  const categories = [
    ...
    },
    {
      ...
      image: NewArrivals, // Make sure to import this image at the top
      cta: "Discover Now",
      cardType: "standard",
      isNew: true, // Using the new property
      link: "/new",
    },
  ];
