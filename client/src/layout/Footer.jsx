      ...
      <div className="max-w-screen-xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
          ...
          <div className="flex flex-col space-y-3">
            ...
            <Link to="/men" className="hover:text-gray-400 transition">
              Men's Collection
            </Link>
            <Link to="/women" className="hover:text-gray-400 transition">
              Women's Collection
            </Link>
            <Link
              to="/kids"
            ...
            <Link to="/sale" className="hover:text-gray-400 transition">
              Sale
            </Link>
          </div>
